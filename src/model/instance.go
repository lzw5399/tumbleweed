...
type ProcessInstance struct {
	...
	State               json.RawMessage `gorm:"type:jsonb" json:"state" form:"state"`                        // 状态信息
	RelatedPerson       json.RawMessage `gorm:"type:jsonb" json:"relatedPerson" form:"relatedPerson"`        // 工单所有处理人
